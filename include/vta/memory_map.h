...
// vta log buffer depth
#define VTA_LOG_UOP_BUFF_DEPTH (VTA_LOG_UOP_BUFF_SIZE - VTA_LOG_UOP_WIDTH + 3)
#define VTA_LOG_WGT_BUFF_DEPTH \
  (VTA_LOG_WEIGHT_BUFF_SIZE - VTA_LOG_BLOCK_OUT - VTA_LOG_BLOCK_IN - VTA_LOG_WEIGHT_BITWIDTH + 3)

#define VTA_LOG_INP_BUFF_DEPTH \
  (VTA_LOG_INPUT_BUFF_SIZE - VTA_LOG_BATCH_SIZE - VTA_LOG_BLOCK_IN - VTA_LOG_INPUT_DATA_BITWIDTH + 3)

#define VTA_LOG_ACC_BUFF_DEPTH \
  (VTA_LOG_ACCUM_BUFF_SIZE - VTA_LOG_BATCH_SIZE - VTA_LOG_BLOCK_OUT - VTA_LOG_ACCUM_BITWIDTH + 3)
...
// TODO: set the memory data bitwidth to its data-type bitwidth. Abstract away the bus_bitwidth
...
#define VTA_INP_MAT_DATA_NUM (VTA_INPUT_MATRIX_BITWIDTH / VTA_INPUT_DATA_BITWIDTH)
#define VTA_WGT_MAT_DATA_NUM (VTA_WEIGHT_MATRIX_BITWIDTH / VTA_WEIGHT_BITWIDTH)
#define VTA_ACCUM_MAT_DATA_NUM (VTA_ACCUM_MATRIX_BITWIDTH / VTA_ACCUM_BITWIDTH)
#define VTA_OUT_MAT_DATA_NUM (VTA_OUT_MATRIX_BITWIDTH / VTA_OUT_BITWIDTH)

#define VTA_INP_NUM_PER_BUS (VTA_BUS_BITWIDTH / VTA_INPUT_DATA_BITWIDTH)
#define VTA_WEIGHT_NUM_PER_BUS (VTA_BUS_BITWIDTH / VTA_WEIGHT_BITWIDTH)
#define VTA_ACCUM_NUM_PER_BUS (VTA_BUS_BITWIDTH / VTA_ACCUM_BITWIDTH)
...
#define VTA_INPUT_MEMORY_DATA_BITWIDTH VTA_INPUT_DATA_BITWIDTH

#define VTA_WEIGHT_MEMORY "vta_weight_memory"
#define VTA_WEIGHT_MEMORY_ENTRY_NUM (VTA_WGT_BUFF_DEPTH * VTA_WGT_MAT_DATA_NUM)
#define VTA_WEIGHT_MEMORY_DATA_BITWIDTH VTA_WEIGHT_BITWIDTH

#define VTA_ACCUM_MEMORY "vta_accum_memory"
#define VTA_ACCUM_MEMORY_ENTRY_NUM (VTA_ACCUM_BUFF_DEPTH * VTA_ACCUM_MAT_DATA_NUM)
#define VTA_ACCUM_MEMORY_DATA_BITWIDTH VTA_ACCUM_BITWIDTH

#define VTA_OUT_MEMORY "vta_out_memory"
#define VTA_OUT_MEMORY_ENTRY_NUM (VTA_ACCUM_BUFF_DEPTH * VTA_OUT_MAT_DATA_NUM)
#define VTA_OUT_MEMORY_DATA_BITWIDTH VTA_OUT_BITWIDTH
...
// vitural DRAM
// ---------------------------------------
// TODO: virtual dram size may not be enough

// virtual DRAM for input
#define VTA_VIRTUAL_DRAM_INPUT "vta_virtual_dram_input"
#define VTA_VIRTUAL_DRAM_INPUT_ENTRY_NUM (VTA_INPUT_MEMORY_ENTRY_NUM << 6)
#define VTA_VIRTUAL_DRAM_INPUT_DATA_BITWIDTH VTA_INPUT_DATA_BITWIDTH

// virtual DRAM for weight
#define VTA_VIRTUAL_DRAM_WEIGHT "vta_virtual_dram_weight"
#define VTA_VIRTUAL_DRAM_WEIGHT_ENTRY_NUM (VTA_WEIGHT_MEMORY_ENTRY_NUM << 6)
#define VTA_VIRTUAL_DRAM_WEIGHT_DATA_BITWIDTH VTA_WEIGHT_BITWIDTH

// virtual DRAM for bias
#define VTA_VIRTUAL_DRAM_BIAS "vta_virtual_dram_bias"
#define VTA_VIRTUAL_DRAM_BIAS_ENTRY_NUM (VTA_ACCUM_MEMORY_ENTRY_NUM << 6)
#define VTA_VIRTUAL_DRAM_BIAS_DATA_BITWIDTH VTA_ACCUM_BITWIDTH

// virtual DRAM for uops
#define VTA_VIRTUAL_UOP_DRAM "vta_virtual_uop_dram"
#define VTA_VIRTUAL_UOP_DRAM_ENTRY_NUM 1024
#define VTA_VIRTUAL_UOP_DRAM_DATA_BITWIDTH VTA_UOP_BITWIDTH

// virtual DRAM for outputs
#define VTA_VIRTUAL_DRAM_OUT "vta_virtual_dram_out"
#define VTA_VIRTUAL_DRAM_OUT_ENTRY_NUM (VTA_OUT_MEMORY_ENTRY_NUM << 6)
#define VTA_VIRTUAL_DRAM_OUT_DATA_BITWIDTH VTA_OUT_BITWIDTH
