...
#define VTA_INPUT_MEMORY_ENTRY_NUM \
  (VTA_INPUT_BUFF_SIZE / (VTA_INPUT_DATA_BITWIDTH / 8))
...
#define VTA_WEIGHT_MEMORY_ENTRY_NUM \
  (VTA_WEIGHT_BUFF_SIZE / (VTA_WEIGHT_BITWIDTH / 8))
...
#define VTA_ACCUM_MEMORY_ENTRY_NUM \
  (VTA_ACCUM_BUFF_SIZE / (VTA_ACCUM_BITWIDTH / 8))
...
#define VTA_OUT_MEMORY_DATA_BITWIDTH VTA_ACCUM_MEMORY_DATA_BITWIDTH
...
#define VTA_VIRTUAL_DRAM_INPUT_ENTRY_NUM (VTA_INPUT_MEMORY_ENTRY_NUM << 1)
...
#define VTA_VIRTUAL_DRAM_WEIGHT_ENTRY_NUM (VTA_WEIGHT_MEMORY_ENTRY_NUM << 1)
...
#define VTA_VIRTUAL_DRAM_BIAS_ENTRY_NUM (VTA_ACCUM_MEMORY_ENTRY_NUM << 1)
